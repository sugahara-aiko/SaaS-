...
const MASTER_DATA = [
  ...
  ['ChatGPT', 'Pro x20', '01_ユーザー課金', 'AIツール', '契約中', '人数課金', 200, 'USD', 2, '',
    '月次', '', true,
    '各自のアカウントで管理(解約時には解約画面を受領)\n∟管理台帳と照合',
    '個別付与(詳細は別シート)', '', '自動化不可(個人課金)'],

  ['ChatGPT', 'Pro x5', '01_ユーザー課金', 'AIツール', '契約中', '人数課金', '', 'USD', 3, '',
    '月次', '', true,
    '各自のアカウントで管理(解約時には解約画面を受領)\n∟管理台帳と照合',
    '個別付与(詳細は別シート)', '', '自動化不可(個人課金)'],

  ['ChatGPT', 'Plus', '01_ユーザー課金', 'AIツール', '契約中', '人数課金', 20, 'USD', 4, '',
    '月次', '', true,
    '各自のアカウントで管理(解約時には解約画面を受領)\n∟管理台帳と照合',
    '個別付与(詳細は別シート)', '', '自動化不可(個人課金)'],
...
const MASTER_FLAGS = [
  ...
  ['ChatGPT', 'Pro x20', 7, '台帳の区分「Pro x20」がChatGPT公式プラン名と不一致。ChatGPT Pro($200/月)と仮定して入力。請求額との突合を推奨'],
  ['ChatGPT', 'Pro x5', 7, '台帳の区分「Pro x5」に該当するChatGPT公式プランが不明($100帯のプランなし)。単価要入力'],
...
const LOG_SEED = [
  ...
  ['2026-07', 'ChatGPT(Pro x20)', 2, '', '', 'OK', '台帳区分の単価は要確認', '', d_(2026, 8, 4)],
  ['2026-07', 'ChatGPT(Pro x5)', 3, '', '', 'OK', '台帳区分の単価は要確認', '', d_(2026, 8, 4)],
